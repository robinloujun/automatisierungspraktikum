function runtlccmd
% RUNTLCCMD - run tlc command (regenerate C code from .rtw file) for model FuzzyNeuro_neuesNetz
% This function will run the tlc command stored in the variable 
% "tlccmd" in tlccmd.mat, whose contents is as follows:
% 
% 	tlc
% 	-r
% 	D:\ATP\3Tank\WS1516\HiWi\Versuch B1 - 3-Tank-System\Simulink\FuzzyNeuro_neuesNetz_rti1104\FuzzyNeuro_neuesNetz.rtw
% 	C:\dSPACE RCPHIL 7.2\matlab\rti1104\tlc\rti1104.tlc
% 	-OD:\ATP\3Tank\WS1516\HiWi\Versuch B1 - 3-Tank-System\Simulink\FuzzyNeuro_neuesNetz_rti1104
% 	-IC:\dSPACE RCPHIL 7.2\matlab\rti1104\tlc
% 	-IC:\dSPACE RCPHIL 7.2\matlab\rti1104\tlc
% 	-ID:\ATP\3Tank\WS1516\HiWi\Versuch B1 - 3-Tank-System\Simulink\FuzzyNeuro_neuesNetz_rti1104\tlc
...
% 	-aProtectedModelReferenceTarget=0
   ...
   if ~sysopen
      ...
      rtwprivate('rtwattic', 'setBuildDir', 'D:\ATP\3Tank\WS1516\HiWi\Versuch B1 - 3-Tank-System\Simulink\FuzzyNeuro_neuesNetz_rti1104');
      rtwprivate('ec_set_replacement_flag', 'FuzzyNeuro_neuesNetz');
      load tlccmd.mat;
      savedpwd = pwd;
      cd ..;
