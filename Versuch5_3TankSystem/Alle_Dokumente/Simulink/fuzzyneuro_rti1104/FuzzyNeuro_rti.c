...
#define RTB_STRUCTURE_NAME             FuzzyNeuro_B
#define RTP_STRUCTURE_NAME             FuzzyNeuro_P
...
__INLINE void rti_mdl_sample_input(void)
{
  ...
  ds1104_adc_start(DS1104_ADC4|DS1104_ADC3);

  /* dSPACE I/O Board DS1104 #1 Unit:ADC Group:MUX */
  {
    static UInt16 channels_conv1[] = { 1, 2, 3 };

    ds1104_adc_read_mux(channels_conv1, 3, FuzzyNeuro_B.SFunction);
  }
}
