/************************ dSPACE target specific file *************************
   ...
   Include file .\fuzzyneuro_rti1104\FuzzyNeuro_th.c :

   Task Configuration file for model : FuzzyNeuro

   RTI1104 6.8 (02-Nov-2011)/2.3
   06-Jun-2016 10:46:28
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\fuzzyneuro_rti1104\FuzzyNeuro_th.c is for ST).
# endif
