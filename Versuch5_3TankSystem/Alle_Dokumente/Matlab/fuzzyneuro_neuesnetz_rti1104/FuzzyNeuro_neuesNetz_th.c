/************************ dSPACE target specific file *************************
   ...
   Include file .\fuzzyneuro_neuesnetz_rti1104\FuzzyNeuro_neuesNetz_th.c :

   Task Configuration file for model : FuzzyNeuro_neuesNetz

   RTI1104 6.8 (02-Nov-2011)/2.3
   30-Oct-2015 09:58:00
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\fuzzyneuro_neuesnetz_rti1104\FuzzyNeuro_neuesNetz_th.c is for ST).
# endif
