...
#
#  $RCSfile: FuzzyNeuro_neuesNetz.mk $ $Revision: 2.43 $ $Date: 2011/08/22 16:30:28MESZ $
#  $ProjectName: e:/ARC/Products/ImplSW/RTISW/RTI/Components/Build/Makefile/project.pj $
# =============================================================================
# NEVER CHANGE THIS LINE:
# RTI_TEMPLATE_MAKEFILE_VERSION = 170
# =============================================================================
...
MAKEFILE                       = FuzzyNeuro_neuesNetz.mk
...
MATLAB_ROOT_ALT                = C:\PROGRA~1\MATLAB\R2011b
MATLAB_BIN_ALT                 = C:\PROGRA~1\MATLAB\R2011b\bin
RELEASE_VERSION                = R2011b
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN
MODEL                          = FuzzyNeuro_neuesNetz
MODULES                        = FuzzyNeuro_neuesNetz_data.c FuzzyNeuro_neuesNetz_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
...
RTWCUST_INCLUDES = \
	$(START_DIR)\FuzzyNeuro_neuesNetz_rti1104 \
	$(START_DIR) \
	D:\ATP\3Tank\VERSUC~1\Simulink \
	$(START_DIR)\fuzzyneuro_neuesnetz_rti1104
...
TMP_PATH_CC += $(MATLAB_ROOT)\rtw\c\src
TMP_PATH_CC += $(MATLAB_ROOT)\rtw\c\src\ext_mode\common
TMP_PATH_CC += $(MATLAB_ROOT)\rtw\c\src\rtiostream\rtiostreamtcpip
